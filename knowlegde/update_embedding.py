...
class UpdateEmbedding:
    def __init__(self):
        self.PROMPT_EXTRACT_FILE = """You are an advanced language model trained to convert unstructured data (pdf, docx, pptx) into structured data in JSON format. Please extract and transform the content from the following document into a JSON record suitable for a database that stores software product marketing materials. Perform the content transformation using Vietnamese. The JSON object should include all of the following fields:
